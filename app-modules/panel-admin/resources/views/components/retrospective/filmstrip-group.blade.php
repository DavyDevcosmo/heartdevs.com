...
<div
    @class([
        'shrink-0 rounded-xl border px-3 py-2.5 transition',
...
>
    <div class="mb-2 flex h-7 items-center gap-2">
        @if ($icon)
        ...
        @else
            <button
                ...
                class="truncate rounded-md text-sm font-semibold text-gray-700 hover:text-primary-600 dark:text-gray-300 dark:hover:text-primary-400"
            >{{ $label }}</button>
            ...
            <button
                ...
                @class([
                    'relative ms-auto h-5 w-9 shrink-0 rounded-full transition',
